  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row container justify-center items-center px-14 pt-16" id="why">
      <div className="basis-1/2">
        <div className="">
          <h1 className="text-5xl font-bold font-serif">Why Us?</h1>
          ...
          <div className="my-4">
            <Link href="/selection-menu">
              <button className="bg-white px-4 py-2 rounded-full translate-y-1 hover:translate-y-0 transition ease-in-out shadow shadow-yellow-500 active:bg-green-400 font-serif">
                Play Now
              </button>
            </Link>
          </div>
