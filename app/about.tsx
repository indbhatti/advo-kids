  ...
  return (
    <div className="flex flex-col lg:flex-row container justify-center items-center px-14 pt-56" id="about">
      ...
      <div className="basis-1/2">
        ...
        <p className="text-xl p-3 font-display">
        ...
        <div className="my-4">
          <Link href="/contact">
            <button className="bg-white px-4 py-2 rounded-full translate-y-1 hover:translate-y-0 transition ease-in-out shadow shadow-yellow-500 active:bg-green-400 ">
            Contact Us
            </button>
          </Link>
        </div>
